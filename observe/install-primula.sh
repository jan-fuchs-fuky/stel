...
cp ./properties/logging.properties /var/lib/tomcat6/webapps/observe/WEB-INF/classes
cp /root/observe/hibernate.cfg.xml /var/lib/tomcat6/webapps/observe/WEB-INF/classes
