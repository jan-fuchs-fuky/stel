...
#
# # ln -s /home/fuky/git/utils/moravian_instruments/lib/libgxccd.so /usr/local/lib/
#
...
ffibuilder.set_source("_gxccd_cffi",
"""
     #include "../include/gxccd.h"   // the C header of the library
""",
     libraries=["gxccd", "rt", "m", "usb-1.0"])   # library name, for the linker
