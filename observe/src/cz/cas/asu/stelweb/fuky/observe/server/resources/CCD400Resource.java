...
@Path("/ccd400")
public class CCD400Resource extends ExposeResource {

    public CCD400Resource(@Context SecurityContext securityCtx,
                          @Context ServletContext servletCtx,
                          @Context HttpServletRequest httpServletRequest,
                          @Context SessionFactory sessionFactory) {

        super(securityCtx, servletCtx, httpServletRequest, sessionFactory, "observe.xmlrpc.ccd400.host", "observe.xmlrpc.ccd400.port");
    }
