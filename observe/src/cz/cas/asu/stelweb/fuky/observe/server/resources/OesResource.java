...
@Path("/oes")
public class OesResource extends ExposeResource {

    public OesResource(@Context SecurityContext securityCtx,
                       @Context ServletContext servletCtx,
                       @Context HttpServletRequest httpServletRequest,
                       @Context SessionFactory sessionFactory) {

        super(securityCtx, servletCtx, httpServletRequest, sessionFactory, "observe.xmlrpc.oes.host", "observe.xmlrpc.oes.port");
    }
