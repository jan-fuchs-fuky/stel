...
@XmlRootElement(name="spectrograph_execute")
public class SpectrographExecuteXML extends ExecuteXML {

    public SpectrographExecuteXML() {
    }

    public SpectrographExecuteXML(String functionName, Object[] functionParams) {
        super(functionName, functionParams);
    }

    public SpectrographExecuteXML(String command) {
        this.functionName = "spectrograph_execute";
