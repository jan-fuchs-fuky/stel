...
CARCDEVICE_API void ArcDevice_SetupController( int bReset, int bTdl, int bPower, int dRows, int dCols, const char* pszTimFile,
											   const char* pszUtilFile, const char* pszPciFile, const int* pAbort, int* pStatus );

CARCDEVICE_API void ArcDevice_LoadControllerFile( const char* pszFilename, int bValidate, const int* pAbort, int* pStatus );
...
CARCDEVICE_API void ArcDevice_Expose( float fExpTime, int dRows, int dCols, const int* pAbort, void ( *pExposeCall )( float ),
									  void ( *pReadCall )( int ), int bOpenShutter, int* pStatus );

CARCDEVICE_API void ArcDevice_StopExposure( int* pStatus );

CARCDEVICE_API void ArcDevice_Continuous( int dRows, int dCols, int dNumOfFrames, float fExpTime, const int* pAbort,
										  void ( *pFrameCall )( int, int, int, int, void * ), int bOpenShutter, int* pStatus );
