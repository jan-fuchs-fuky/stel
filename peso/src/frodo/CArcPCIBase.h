...
namespace arc
{
	namespace device
	{
		...
		// +-------------------------------------------------------------------+
		typedef std::auto_ptr<CStringList> CStrListPtr;
		...
		typedef std::tr1::shared_ptr<PCIRegData> PCIRegDataPtr;
		...
		// |  exist )                                                          |
		// +-------------------------------------------------------------------+
		typedef std::tr1::shared_ptr<PCIRegList> PCIRegListPtr;
		...
		typedef std::tr1::shared_ptr<PCIBarData> PCIBarDataPtr;
		...
		class CARCDEVICE_API CArcPCIBase : public CArcDevice
		{
			...
			protected:
				...
				std::tr1::shared_ptr<PCIRegList> m_pCfgSpList;
				std::tr1::shared_ptr<PCIBarList> m_pBarList;

				std::tr1::shared_ptr<std::string> m_pTmpCfgBitList;
				std::tr1::shared_ptr<std::string> m_pTmpBarBitList;
		};
