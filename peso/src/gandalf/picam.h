...
typedef enum PicamError
{
    ...
    /*------------------------------------------------------------------------*/
    PicamError_InvalidNvramSection                 = 41
    /*------------------------------------------------------------------------*/
} PicamError; /* (43) */
/*----------------------------------------------------------------------------*/
/* Library Version -----------------------------------------------------------*/
...
typedef enum PicamEnumeratedType
{
    ...
    /* For Internal Use Only -------------------------------------------------*/
    /*------------------------------------------------------------------------*/
    PicamEnumeratedType_NvramSection            = 37
    /*------------------------------------------------------------------------*/
} PicamEnumeratedType; /* (42) */
/*----------------------------------------------------------------------------*/
...
{
    PicamCcdCharacteristicsMask_None            = 0x00,
    PicamCcdCharacteristicsMask_BackIlluminated = 0x01,
    PicamCcdCharacteristicsMask_DeepDepleted    = 0x02,
    PicamCcdCharacteristicsMask_OpenElectrode   = 0x04,
    PicamCcdCharacteristicsMask_UVEnhanced      = 0x08,
    PicamCcdCharacteristicsMask_ExcelonEnabled  = 0x10,
    PicamCcdCharacteristicsMask_SecondaryMask   = 0x20,
    PicamCcdCharacteristicsMask_Multiport       = 0x40
} PicamCcdCharacteristicsMask; /* (0x80) */
/*----------------------------------------------------------------------------*/
...
} PicamPhotocathodeSensitivity; /* (7) */
/*----------------------------------------------------------------------------*/
