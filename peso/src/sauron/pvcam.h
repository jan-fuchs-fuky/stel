...
#ifndef _PVCAM_H
#define _PVCAM_H
//static const char *_pvcam_h_="$Header: /PVCAM v2.6/SourceCommon/pvcam.h 30    11/18/04 5:12p Skatsumata $";
...
enum TIME_UNITS
{
    TU_DAY = 10, TU_HOUR = 5, TU_MINUTE = 4, TU_SEC = 3, TU_MSEC = 2, /* millisecond  */
...
rs_bool PV_DECL pl_cam_open(char_ptr camera_name, int16_ptr hcam, int16 o_mode);
...
rs_bool PV_DECL pl_get_param(int16 hcam, uns32 param_id, int16 param_attribute,
        void_ptr param_value);
rs_bool PV_DECL pl_set_param(int16 hcam, uns32 param_id, void_ptr param_value);
...
rs_bool PV_DECL pl_exp_get_driver_buffer(int16 hcam, void_ptr_ptr pixel_stream,
        uns32_ptr byte_cnt);
rs_bool PV_DECL pl_exp_setup_seq(int16 hcam, uns16 exp_total, uns16 rgn_total,
        rgn_const_ptr rgn_array, int16 exp_mode, uns32 exposure_time,
        uns32_ptr exp_bytes);
...
rs_bool PV_DECL pl_exp_setup_cont(int16 hcam, uns16 rgn_total,
        rgn_const_ptr rgn_array, int16 exp_mode, uns32 exposure_time,
        uns32_ptr exp_bytes, int16 buffer_mode);
rs_bool PV_DECL pl_exp_start_cont(int16 hcam, void_ptr pixel_stream, uns32 size);
...
rs_bool PV_DECL pl_exp_check_cont_status(int16 hcam, int16_ptr status,
        uns32_ptr bytes_arrived, uns32_ptr buffer_cnt);
...
rs_bool PV_DECL pl_exp_finish_seq(int16 hcam, void_ptr pixel_stream, int16 hbuf);
rs_bool PV_DECL pl_exp_unravel(int16 hcam, uns16 exposure,
        void_ptr pixel_stream, uns16 rgn_total, rgn_const_ptr rgn_array,
...
rs_bool PV_DECL pl_buf_alloc(int16_ptr hbuf, int16 exp_total, int16 bit_depth,
        int16 rgn_total, rgn_const_ptr rgn_array);
rs_bool PV_DECL pl_buf_get_bits(int16 hbuf, int16_ptr bit_depth);
rs_bool PV_DECL pl_buf_get_exp_date(int16 hbuf, int16 exp_num, int16_ptr year,
        uns8_ptr month, uns8_ptr day, uns8_ptr hour, uns8_ptr min, uns8_ptr sec,
        uns16_ptr msec);
rs_bool PV_DECL pl_buf_set_exp_date(int16 hbuf, int16 exp_num, int16 year,
        uns8 month, uns8 day, uns8 hour, uns8 min, uns8 sec, uns16 msec);
...
rs_bool PV_DECL pl_buf_get_img_bin(int16 himg, int16_ptr ibin, int16_ptr jbin);
rs_bool PV_DECL pl_buf_get_img_handle(int16 hbuf, int16 exp_num, int16 img_num,
        int16_ptr himg);
rs_bool PV_DECL pl_buf_get_img_ofs(int16 himg, int16_ptr s_ofs, int16_ptr p_ofs);
...
rs_bool PV_DECL pl_ccd_get_frame_capable(int16 hcam, rs_bool_ptr frame_capable);
/* Use PARAM_FRAME_CAPABLE                                        */
rs_bool PV_DECL pl_ccd_get_fwell_capacity(int16 hcam, uns32_ptr fwell_capacity);
...
rs_bool PV_DECL pl_ccd_get_summing_well(int16 hcam, rs_bool_ptr s_well_exists);
...
rs_bool PV_DECL pl_spdtab_get_max_gain(int16 hcam, int16_ptr spdtab_max_gain);
...
rs_bool PV_DECL pl_subsys_do_diag(int16 hcam, uns8 subsys_id,
        uns16_ptr err_code);
rs_bool PV_DECL pl_subsys_get_id(int16 hcam, uns8 subsys_id, uns16_ptr part_num,
        uns8_ptr revision);
